...
function CreatorForm() {
  ...
  return (
    <div className="App mt-36 md:mt-0 w-full  flex flex-col items-center justify-center">
      <span className="text-2xl font-bold">Numero de artículos: {posts.length}</span>
        ...
        {posts.map((i) => (
          <div className="no-scrollbar flex w-full  border-2 border-gray-300 gap-8 rounded-xl shadow-2xl  h-96 px-10 my-3 overflow-y-scroll ">
            <div className="w-full no-scrollbar overflow-y-scroll py-1">
              ...
              <img src={i.photo} alt="" />
              <h3>{i.copete}</h3>
              <h2 className="text-xl">{ReactHtmlParser(i.description)}</h2>

              <h2 className="text-xl">{ReactHtmlParser(i.creator)}</h2>
            </div>
            ...
            <div className="flex flex-col relative  ">
              <button
                ...
                onClick={() =>
                  deleteFile(`https://lujan-en-5-api.herokuapp.com/api/posts/${i._id}`)
                }
              >
              ...
              <div className="absolute bottom-3">
                <div className="flex text-center justify-center px-2 py-2">
                  <img className=" h-5 mt-2" src={views} alt="" />
                  <span className="font-bold text-2xl ml-3 text-gray-700 underline">
                    {i.clicks}
                  </span>
                </div>
                ...
                <div className="flex text-center ">
                  ...
                  <span className="font-bold text-2xl px-5 text-gray-700  text-center">
